            ...
            <div class="flex border-b border-40">
                ...
                <div class="py-6 px-8 w-1/2">
                    ...
                    <div class="help-text help-text mt-2" v-if="createdSupportTicket">
                        Support Ticket:
                        <a target="_blank" :href="createdSupportTicket.url">ID: {{ createdSupportTicket.id }} - {{createdSupportTicket.subject}} {{createdSupportTicket.isExist}}</a>
                    </div>
                </div>
            </div>
            <div v-if="showCreateIssueForm" class="bg-30">
                <div class="flex border-b border-40">
                    ...
                    <div class="py-6 px-8 w-4/5">
                        <textarea v-model="issueDescription" rows="5" placeholder="Description"
                                  class="w-full form-control form-input form-input-bordered py-3 h-auto"></textarea>
                        <!---->
            ...
            <span class="form-file mr-4">
              <input type="file" ref="file" v-on:change="handleFileUpload()"/>
                ...
                <div class="flex border-b border-40">
                    ...
                    <div class="py-6 px-8 w-4/5">
                        <button type="button" :disabled="!this.issueDescription"
                                class="btn btn-default btn-primary inline-flex items-center relative"
                                @click="createDailyCheckIssue">
    ...
    methods: {
        ...
        setOption(event) {
            ...
            if (this.dailyCheckItemStatus == "Not Okay") {
                this.loading = true;
                axios
                    .post("/nova-vendor/daily-checks/isExist", {
