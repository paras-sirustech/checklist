...
var update = __webpack_require__(1)("283f0064", content, false, {});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      ...
      checkingDate: '',
      selectedShop: '',
      validationErrors: new __WEBPACK_IMPORTED_MODULE_0_laravel_nova__["Errors"]()
    };
  },
  mounted: function mounted() {
    this.getShops();
  ...
  methods: {
    getShops: function getShops() {
      this.loading = true;
      axios.get("/nova-vendor/daily-checks/shops").then(function (response) {
        this.loading = false;
    ...
    startDailyCheck: function startDailyCheck() {
      axios.post("/nova-vendor/daily-checks/start", {
        ...
        if (error.response.status == 422) {
          this.validationErrors = new __WEBPACK_IMPORTED_MODULE_0_laravel_nova__["Errors"](error.response.data.errors);
        }
      }.bind(this));
    }
  },
            ...
            "form",
            {
              ...
              on: {
                submit: function($event) {
                  ...
                  return _vm.startDailyCheck.apply(null, arguments)
                }
              }
            },
            [
              ...
              _c("div", { staticClass: "flex items-center" }, [
                ...
                _c(
                  "button",
                  {
                    ...
                    attrs: { type: "button", dusk: "next-button" },
                    on: {
                      click: function($event) {
                        return _vm.startDailyCheck()
                      }
                    }
                  },
                  [_c("span", {}, [_vm._v("Next")])]
...
Component.options.__file = "resources/js/components/NewDailyCheck.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-8bf72f58", Component.options)
  } else {
    hotAPI.reload("data-v-8bf72f58", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("30d24b04", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-8bf72f58\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./NewDailyCheck.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-8bf72f58\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./NewDailyCheck.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_ChecklistInput_vue__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_ChecklistInput_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__components_ChecklistInput_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_laravel_nova__ = __webpack_require__(3);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    "checklist-input": __WEBPACK_IMPORTED_MODULE_0__components_ChecklistInput_vue___default.a
  },
  ...
  data: function data() {
    return {
      ...
      checklistItemStatus: [],
      checklistOptions: [{ label: "Okay", value: "Okay" }, { label: "Not Okay", value: "Not Okay" }],
  ...
  methods: {
    fileDailyCheck: function fileDailyCheck() {
      this.loading = true;
      axios.post("/nova-vendor/daily-checks/file", {
        shop: this.shop,
        date: this.date
      }).then(function (response) {
        this.loading = false;
        ...
        if (error.response.data.message) {
          ...
          this.$toasted.show("Error! Unable to File. Please try again later or contact support", { type: "error" });
        }
      }.bind(this));
    },
    setItemOption: function setItemOption(value) {
      var index = this.checklistItemStatus.map(function (x) {
        return x.id;
      }).indexOf(value.id);
      ...
      if (this.checklistItemStatus.length == this.selectedShop.checklist.items.length) {
    ...
    startDailyCheck: function startDailyCheck() {
      axios.post("/nova-vendor/daily-checks/start", {
        ...
        if (error.response.data.message) {
          ...
          this.$toasted.show("Error! Unable to start. Please try again later or contact support", { type: "error" });
        }
      }.bind(this));
    }
  },
...
Component.options.__file = "resources/js/components/ChecklistInput.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4e7e96ef", Component.options)
  } else {
    hotAPI.reload("data-v-4e7e96ef", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("42882af9", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-4e7e96ef\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./ChecklistInput.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-4e7e96ef\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./ChecklistInput.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
            ...
            if (this.dailyCheckItemStatus == "Not Okay") {
                ...
                axios.post("/nova-vendor/daily-checks/isExist", {
                    ...
                    if (response.data.data) {
                        this.showCreateIssueForm = false;
                        this.createdSupportTicket = response.data.data;
                        this.createdSupportTicket.isExist = "already exists , please click okay until that ticket is resolved";
                        this.notifyParent();
                    ...
                    if (error.response.data.message) {
                        ...
                        this.$toasted.show("Error! Unable to save item. Please try again later or contact support", { type: "error" });
                    }
                }.bind(this));
            }
        },

        createDailyCheckIssue: function createDailyCheckIssue() {
            this.loading = true;
            ...
            axios.post("/nova-vendor/daily-checks/item-create-issue", formData, {
                headers: {
                ...
                if (error.response.status === 413) {
                    this.$toasted.show("Error! Attached file is too large. Please try with a smaller attachment", { type: "error" });
                } else {
                    if (error.response.data.message) {
                        this.$toasted.show(error.response.data.message, {
                            type: "error"
                        ...
                        this.$toasted.show("Error! Unable to create Issue. Please try again later or contact support", { type: "error" });
                    }
                }
            }.bind(this));
        },
        submitDailyCheckItem: function submitDailyCheckItem() {
            this.loading = true;
            axios.post("/nova-vendor/daily-checks/save-item", {
                checklist_item_id: this.item.id,
    ...
    [
      _vm.loading
        ...
        : _c("div", [
              ...
              _c("div", { staticClass: "py-6 px-8 w-1/2" }, [
                _c(
                    ...
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model",
                        value: _vm.dailyCheckItemStatus,
                        expression: "dailyCheckItemStatus"
                      }
                    ],
                    ...
                    on: {
                      change: [
                        function($event) {
                          ...
                          _vm.dailyCheckItemStatus = $event.target.multiple
                            ? $$selectedVal
                            : $$selectedVal[0]
                        },
                        _vm.setOption
                  ...
                  [
                    ...
                    _vm._v(" "),
                    _c("option", { attrs: { value: "Okay" } }, [
                      _vm._v("Okay")
                    ]),
                    _vm._v(" "),
                    _c("option", { attrs: { value: "Not Okay" } }, [
                      _vm._v("Not Okay")
                    ])
                  ]
                ),
                _vm._v(" "),
                _vm.createdSupportTicket
                  ? _c("div", { staticClass: "help-text help-text mt-2" }, [
                      ...
                      _c(
                        "a",
                        {
                          attrs: {
                            target: "_blank",
                            href: _vm.createdSupportTicket.url
                          }
                        },
                        [
                          _vm._v(
                            "ID: " +
                              _vm._s(_vm.createdSupportTicket.id) +
                              " - " +
                              _vm._s(_vm.createdSupportTicket.subject) +
                              " " +
                              _vm._s(_vm.createdSupportTicket.isExist)
                          )
                        ]
                      )
                    ])
            ...
            _vm._v(" "),
            _vm.showCreateIssueForm
              ? _c("div", { staticClass: "bg-30" }, [
                  _c("div", { staticClass: "flex border-b border-40" }, [
                    _c("div", { staticClass: "w-1/5 px-8 py-6" }, [
                      _c(
                        "label",
                    ...
                    _c("div", { staticClass: "py-6 px-8 w-4/5" }, [
                      _c("textarea", {
                        ...
                        domProps: { value: _vm.issueDescription },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                            }
                            _vm.issueDescription = $event.target.value
                          }
                        }
                      }),
                      _vm._v(" "),
                    ...
                    _c("div", { staticClass: "py-6 px-8 w-4/5" }, [
                      _c(
                        "button",
                        {
                          ...
                          attrs: {
                            type: "button",
                            disabled: !this.issueDescription
                          },
                          on: { click: _vm.createDailyCheckIssue }
                        },
                        [_c("span", {}, [_vm._v("Save and Create Ticket")])]
                      )
                    ])
                  ])
                ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-4e7e96ef", module.exports)
  }
}
        ...
        ? _c(
            ...
            [
              _c("div", { staticClass: "mb-8" }, [
                _c("h1", { staticClass: "mb-3 text-90 font-normal text-2xl" }, [
                  _vm._v(
                    _vm._s(this.selectedShop.name) +
                      " - " +
                      _vm._s(_vm._f("moment")(this.date, "MMM Do, YYYY"))
                  )
                ]),
                _vm._v(" "),
                _c(
                  "div",
                  { staticClass: "card" },
                  _vm._l(_vm.selectedShop.checklist.items, function(item) {
                    return _c(
                      "div",
                      { key: item.id },
                      [
                        _c("checklist-input", {
                          ...
                          on: { selectItemOption: _vm.setItemOption }
                        })
                      ],
                      1
                    )
              ...
              _c("div", { staticClass: "flex items-center" }, [
                ...
                _c(
                  "button",
                  {
                    ...
                    attrs: {
                      type: "button",
                      disabled: !_vm.checklistSubmitReady,
                      dusk: "next-button"
                    },
                    on: {
                      click: function($event) {
                        return _vm.fileDailyCheck()
                      }
                    }
                  },
                  [_c("span", {}, [_vm._v("File Daily Check")])]
                )
              ])
            ]
          )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-8bf72f58", module.exports)
  }
}
